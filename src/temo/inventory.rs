use specs::prelude::*;
use super::{WantsToPickupItem, Name, InBackpack, Position, logs::GameLog, WantsToUseItem,
    Consumable, ProvidesHealing, Stats, WantsToDropItem, InflictsDamage, Map, SufferDamage,
